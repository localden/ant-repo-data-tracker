...
function consolidateMonthlyData(monthKey: string, snapshots: DailySnapshot[]): DailySnapshot {
  ...
  return {
    ...
    issues: {
      ...
      assigned: avg((s) => s.issues.assigned),
      unassigned: avg((s) => s.issues.unassigned),
      unassigned_24h: avg((s) => s.issues.unassigned_24h),
      unassigned_7d: avg((s) => s.issues.unassigned_7d),
      unassigned_30d: avg((s) => s.issues.unassigned_30d),
      ...
      assignment_time: {
        avg_hours: avgFloat((s) => s.issues.assignment_time?.avg_hours),
        median_hours: avgFloat((s) => s.issues.assignment_time?.median_hours),
        p90_hours: avgFloat((s) => s.issues.assignment_time?.p90_hours),
        p95_hours: avgFloat((s) => s.issues.assignment_time?.p95_hours),
      },
      close_time: {
    ...
    pulls: {
      ...
      assigned: avg((s) => s.pulls.assigned),
      unassigned: avg((s) => s.pulls.unassigned),
      unassigned_24h: avg((s) => s.pulls.unassigned_24h),
      unassigned_7d: avg((s) => s.pulls.unassigned_7d),
      review_time: {
      ...
      assignment_time: {
        avg_hours: avgFloat((s) => s.pulls.assignment_time?.avg_hours),
        median_hours: avgFloat((s) => s.pulls.assignment_time?.median_hours),
        p90_hours: avgFloat((s) => s.pulls.assignment_time?.p90_hours),
        p95_hours: avgFloat((s) => s.pulls.assignment_time?.p95_hours),
      },
      merge_time: {
